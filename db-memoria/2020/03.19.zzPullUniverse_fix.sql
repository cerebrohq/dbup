-- FUNCTION: public."zzPullUniverse"(character varying, text)

-- DROP FUNCTION public."zzPullUniverse"(character varying, text);
...
begin
	...
	*/
	...
	INSERT INTO status(uid, "name", flags, order_no, description, icon_xpm, color, unid, perm_leave_bits, perm_enter_bits, mtm, icon_hash, icon)
		select * from
